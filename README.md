...
MuchHeap is still very much a work in progress, but its intent is to expose a useful API for developers to automate rules for analysing heap dumps. Work will continue on making MuchHeap loading/processing times faster.

...
public class OriginalHProfReader extends com.sun.tools.hat.internal.parser.Reader
  ...
  public OriginalHProfReader(String fileName, PositionDataInputStream in,
                             int dumpNumber, boolean callStack, int debugLevel)
      throws IOException {
    super(in);
    RandomAccessFile file = new RandomAccessFile(fileName, "r");
    this.snapshot = new Snapshot(OriginalMappedReadBuffer.create(file));
